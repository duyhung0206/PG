 ...
 */
class Magestore_Promotionalgift_Block_Adminhtml_Reportcartrule_Graph extends Mage_Adminhtml_Block_Dashboard_Graph
{
    ...
    protected $_height = '410';

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('promotionalgift/report/template.phtml');
    }
    ...
    public function getChartUrl($directUrl = true)
    {
        ...
        //difference
        list ($dateStart, $dateEnd) = Mage::getResourceModel('promotionalgift/sale_collection')
